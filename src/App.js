...
import BackTop from "./components/backToTop/backTop.js";
      ...
      <>
        <div id="dpMain" className="discount-popup-box-main">
          <div className="discount-popup-main">
            ...
            <p className="dp-head">Yay! You just got 20% off.</p>
            ...
            <form className="dp-form">
              ...
              <input
                type="submit"
                className="dp-submit"
                value="Reveal Promo Code"
              />
            </form>

            <p className="dp-text">
              Consequat proident non cillum enim veniam proident do qui veniam
              laboris esse. Aliqua et duis quis ad dolor. Ut quis ea ullamco do
              nulla et est qui velit.
            </p>
          </div>
        </div>
      </>

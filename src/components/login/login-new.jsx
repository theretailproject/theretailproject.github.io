...
function LogInNew() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      document.getElementsByClassName("singup-new-submit")[0].value =
        "Signing In..";
    ...
    <div className="SignUpNew">
      ...
      <div className="signup-new-box">
        <div className="signup-head">
          <p className="signup-new-head">Welcome!</p>
          <p className="singup-new-text">Use your credentials to access</p>
        </div>

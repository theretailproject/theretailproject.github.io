...
import noOrder from "./sad_dog.png";
...
function Orders() {
  ...
  function openTrackingDiv(order) {
    setCurrOrder(order);
    document.getElementById("overlaySignInId").style.display = "flex";
    setStageIndex(getCurrentStageIndex(order?.status || ""));
  }
  function closeTrackingDiv() {
  ...
  function updateOrderStatus(currentStatus) {
    ...
    return currentStatus; // Already at 'Delivered' or invalid
  }

  function openConfirmationBox(order) {
    document.getElementById("overlayConfirmation").style.display = "flex";
  }
  function cancelOrder(order) {
    alert("Cancellation under process!");
    closeConfirmationBox();
  }

  function closeConfirmationBox() {
    document.getElementById("overlayConfirmation").style.display = "none";
  }
  ...
  return (
    <div className="OrdersNew">
      <div className="overlaySignIn" id="overlaySignInId">
        <div className="overlaySignInChildren">
          <div className="overlaySignInChild">
            <div className="overlaySignInChild1">
              Order :{" "}
              {currOrder && currOrder.orderId
                ? currOrder.orderId
                : "Loading..."}
            </div>
            <>
              <p>
                <strong>Item:</strong> {currOrder?.name || "Loading..."}
              </p>
              <p>
                <strong>Quantity:</strong> {currOrder?.quantity || "Loading..."}
              </p>
              <p>
                <strong>Price:</strong> ₹
            ...
            <div className="trackingContainer">
              <div className="trackingBar">
                ...
                <div
                  ...
                  style={{
                    width: `${(stageIndex / (orderStages.length - 1)) * 100}%`,
                  }}
                />
      ...
      <div className="overlaySignIn" id="overlayConfirmation">
        <div className="overlaySignInChildren">
          <div className="overlaySignInChild">
            <p className="overlaySignInChild1">Are you sure to proceed?</p>
            <div className="overlayBtns">
              {" "}
              <button className="overlaySignInChildBtn1" onClick={cancelOrder}>
                Yes, Cancel
              </button>
              <button
                    ...
                    <div className="order-box-card">
                      ...
                      <div className="order-right">
                        <div className="order-right-upper">
                          ...
                          <p className="oqty">
                            Ordered on{" "}
                            {o.orderedAt.toDate().toLocaleDateString()}
                          </p>
                          <p className="oqty">Status: {o.status}</p>
                        </div>
                    ...
                    <div className="order-box-card">
                      ...
                      <div className="order-right">
                        <div className="order-right-upper">
                          <p className="oname">{o.name}</p>
                          <p className="oqty">Qty. {o.quantity}</p>
                          <p className="oqty">Price : ₹ {o.price}</p>
                          <p className="oqty">
                            Ordered on{" "}
                            {o.orderedAt.toDate().toLocaleDateString()}
                          </p>
                          <p className="oqty">
                            Delivered on{" "}
                            {o.deliveredAt.toDate().toLocaleDateString()}
                          </p>
                        </div>
                        ...
                        <div className="order-right-lower">
                          <div className="order-right-delivered">
                            ...
                            <div className="order-delivered-opt">
                              <p className="odt">Get Support</p>
                              <p className="odt">Review product</p>
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <div id="invoice" className="invoice-box">
            <div className="invoice-upper">
              <div className="invoice-upper-left">
                ...
                <div className="in-box">
                  ...
                  <p className="in-text">
                    {orderInvoice.deliveryDt?.toDate().toLocaleDateString()}
                  </p>
                </div>
              </div>
            ...
            <div className="payable-box">
              <div className="payable-to">
                <p className="payable-to-text">PAYABLE TO</p>
                <p className="normal-text">{orderInvoice.username}</p>
                <p className="normal-text">{orderInvoice.address}</p>
              </div>
              {/* <div className="payable-to">
            ...
            <div className="payable-box idbox">
              <div className="payable-to">
                <p className="payable-to-text">ITEM</p>
                <p className="normal-text iname">{orderInvoice.prodName}</p>

                <div className="payment-mode">
                  <p className="payable-to-text">Payment Method</p>
                  <p className="normal-text">Online</p>
                </div>
              </div>
              <div className="payable-to tboxmain ">
                <div className="qty-sec">
                  <div className="qty">
                    <p className="payable-to-text">QTY</p>
                    <p className="normal-text">{orderInvoice.qty}</p>
                  </div>
                  <div className="qty">
                    <p className="payable-to-text">PRICE</p>
                    <p className="normal-text">₹ {orderInvoice.price}</p>
                  </div>
                  <div className="qty">
                    <p className="payable-to-text">TOTAL</p>
                    <p className="normal-text">
                ...
                <div className="total-sec">
                  <div className="tbox">
                    <p className="normal-text">Sub Total</p>
                    <p className="normal-text">₹ {orderInvoice.price}</p>
                  </div>
                  <div className="tbox">
                    <p className="normal-text">Shipping</p>
                    <p className="normal-text">₹ 80</p>
                  </div>
                  <div className="tbox">
                    <p className="normal-text">Grand Total</p>
                    <p className="normal-text">
            ...
            <div className="payable-box thanks-sec">
              <div className="socialsi">
                <div className="sociali">
                  <img
                    src={require("./phone-call.png")}
                    alt=""
                    className="siimg"
                  />
                  <p className="sub-text">+91 9664149148</p>
                </div>
                <div className="sociali">
                  <img src={require("./email.png")} alt="" className="siimg" />
                  <p className="sub-text">contact@theretailproject.in</p>
                </div>
                <div className="sociali">
                  <img src={require("./gps.png")} alt="" className="siimg" />
                  <p className="sub-text">Udaipur, India</p>
                </div>
                <div className="sociali">
                  <img src={require("./web.png")} alt="" className="siimg" />
                  <p className="sub-text">retailproject.in</p>
                </div>
              </div>
              <div className="thanks">
                <p className="sub-text">
                  ...
                  <br />
                  Thank you for shopping with us! We hope your pet loves their
                  new item
                  <br />
                  <b>
                    Enjoy 25% off on the order of upcycled products with code
                    UPCYCLE25
                  </b>
                </p>
              </div>
